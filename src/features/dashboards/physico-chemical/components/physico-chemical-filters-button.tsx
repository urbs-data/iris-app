...
import { PhysicoChemicalFilters } from './physico-chemical-filters';
...
export function PhysicoChemicalFiltersButton() {
  const t = useTranslations('substance');
  const [open, setOpen] = useState(false);
  const activeFiltersCount = useActiveFiltersCount(fqSearchParams);
